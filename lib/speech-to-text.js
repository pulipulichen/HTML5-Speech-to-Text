let SpeechToText = {
  ...
  getDuration: function () {
    ...
    var finishTime = new Date(currentTime + (this.playerDuration * 1000))
    var finishTimeStr = this.prefixPaddingZero(finishTime.getHours(), 2) + ':' + this.prefixPaddingZero(finishTime.getMinutes(), 2) + ":" + this.prefixPaddingZero(finishTime.getSeconds(), 2)
